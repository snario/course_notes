  ...
  \newline
   ...
   \section{Introduction to the Formalism and Structure of Quantum Mechanics}
     ...
     \subsection{Stern Gerlach Experiments}
       ...
       \subsection{Stern-Gerlach Experiment 1}
       ...
       \subsection{Stern-Gerlach Experiment 2}
       ...
       \subsection{Stern-Gerlach Experiment 3}
      ...
      \subsection{Stern-Gerlach Experiment 4}
       ...
       \subsection{Quantum State Vectors}
         ...
         \begin{itemize}
            ...
            \item They are complete (only 2 possible outcomes).
            \item They are orthogonal; the result is either spin up or spin down.
          \end{itemize}

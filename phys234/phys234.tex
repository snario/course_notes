   ...
   \section{Linear Algebra Review}
     ...
     \subsection{Matrices}
        ...
        \begin{defn}[transpose]\label{transpose}
          The interchange of rows and columns of the matrix. Transpose of column is row and vice cersa. The transpose of a square matrix is to reflect elements in main diagonal.
        \end{defn}

   ...
   \section{Introduction to the Formalism and Structure of Quantum Mechanics}
    ...
    \subsection{Quantum Mechanical Operators and Measurement}
      ...
      \subsubsection{Completeness Relationship}
        ...
        Hence $\ket{+}\bra{+} + \ket{-}\bra{-} = I$, the identity operator. This is known as the completeness relation. Note that $\ket{+}\bra{+}$ and $\ket{-}\bra{-}$ are projection operators, and are an example of an outer product.
